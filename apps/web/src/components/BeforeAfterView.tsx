    ...
    <div className="w-full max-w-4xl mx-auto">
      ...
      >
        ...
        <img
          ...
          draggable={false}
        />
        <span className="absolute bottom-4 right-4 px-3 py-1 bg-green-600 text-white text-sm font-medium rounded-full z-10">
          After
        </span>
        ...
        />
        <span 
          className="absolute bottom-4 left-4 px-3 py-1 bg-zinc-800 text-white text-sm font-medium rounded-full z-10"
          style={{ 
